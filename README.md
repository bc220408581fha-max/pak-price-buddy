...
- **Products catalog** — browse grocery and household items by category (Grocery, Dairy, Produce, Household), with new items auto-categorized when reported
...
- **"Still accurate" reviews** — users can confirm whether an older reported price is still valid, keeping the crowdsourced data trustworthy
- **Dashboard overview** — monthly budget, current shopping list estimate, budget usage progress bar, quick access to the AI Assistant, and a live feed of recently reported prices from all users
...
- **AI Shopping Assistant** — a persistent chat interface (saved across sessions) that gives personalized, budget-aware recommendations using real reported price data
...
Simply visit **https://pak-price-buddy.lovable.app** and sign up with any email and password, or continue with Google.
