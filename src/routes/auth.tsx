...
export const Route = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [
      { title: "Sign in — AI Price Tracker" },
      { name: "description", content: "Sign in or create an account to track grocery prices and plan your budget." },
      { property: "og:title", content: "Sign in — AI Price Tracker" },
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-secondary/40 to-background px-4 py-10">
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="mt-3 text-2xl font-bold tracking-tight">AI Price Tracker</h1>
          <p className="text-sm text-muted-foreground">Smarter grocery shopping in Pakistan</p>
        </div>
            ...
            <Tabs defaultValue="signin">
              ...
              <TabsContent value="signup">
                <form onSubmit={signUp} className="space-y-3 mt-4">
                  ...
                  <div>
                    <Label htmlFor="password2">Password (min 6)</Label>
